...
from utils.data_utils import load_dataset_splits
from utils.metrics import calculate_metrics
from utils.visualization import save_comparison_visualization
...
def main():
    ...
    try:
        ...
        pretrained_predictor = load_sam2_model(args.model_cfg, args.pretrained_checkpoint, device)
        ...
        finetuned_predictor = load_sam2_model(args.model_cfg, args.finetuned_checkpoint, device)
